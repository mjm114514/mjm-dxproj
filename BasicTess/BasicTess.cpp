...
{
public:
	BasicTess(HINSTANCE hInstance);
    BasicTess(const BasicTess& rhs) = delete;
    BasicTess& operator=(const BasicTess& rhs) = delete;
	~BasicTess();
...
BasicTess::BasicTess(HINSTANCE hInstance)
: D3DApp(hInstance) 
{
}
...
void BasicTess::Update(const GameTimer& gt)
{
...
void BasicTess::BuildConstantBuffers()
{
    ...
    int quadpatchCBufIndex = 0;
	cbAddress += quadpatchCBufIndex*objCBByteSize;
...
void BasicTess::BuildShadersAndInputLayout()
{
	...
	mShaders["VS"] = d3dUtil::CompileShader(L"Shaders\\tess.hlsl", nullptr, "VS", "vs_5_0");
	mShaders["PS"] = d3dUtil::CompileShader(L"Shaders\\tess.hlsl", nullptr, "PS", "ps_5_0");
    mShaders["HS"] = d3dUtil::CompileShader(L"Shaders\\tess.hlsl", nullptr, "HS", "hs_5_0");
    mShaders["DS"] = d3dUtil::CompileShader(L"Shaders\\tess.hlsl", nullptr, "DS", "ds_5_0");
