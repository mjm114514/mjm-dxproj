...
public:
    ...
    LightingApp(const LightingApp& rhs) = delete;
    LightingApp& operator=(const LightingApp& rhs) = delete;
	~LightingApp();
...
void LightingApp::Update(const GameTimer& gt)
{
...
void LightingApp::Draw(const GameTimer& gt)
{
...
void LightingApp::BuildDescriptorHeaps()
{
...
void LightingApp::BuildBoxGeometry()
{
